...
func ed25519GenerateKeySeed(_ ed25519Seed) (public ed25519PublicKey, secret ed25519PrivateKey) {
	return
}

func ed25519Sign(_ ed25519PrivateKey, _ []byte) (sig ed25519Signature) {
	var signature [64]byte
	return signature

}

func ed25519Verify(_ ed25519PublicKey, _ []byte, _ ed25519Signature, _ bool) bool {
	return true
}
...
func SecretKeyToPublicKey(_ PrivateKey) (PublicKey, error) {
	var pk PublicKey
	return pk, nil
}
...
func SecretKeyToSeed(_ PrivateKey) (Seed, error) {
	var seed Seed
	return seed, nil
}
