...
type Balances interface {
	...
	// GetEx is like Get, but also loads specific creatable
	...
	// PutWithCreatable is like Put, but should be used when creating or deleting an asset or application, or its holdings
	PutWithCreatable(addr basics.Address, acct basics.AccountData, creatableMods *basics.CreatableLocator) error
