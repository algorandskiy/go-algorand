...
func TestCompactDeltas(t *testing.T) {
	...
	accountDeltas[0].Upsert(addrs[0], basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 2}}})
	...
	require.Equal(t, basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 2}}}, delta.new)
	...
	accountDeltas[1].Upsert(addrs[0], basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 3}}})
	accountDeltas[1].Upsert(addrs[3], basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 8}}})
	...
	baseAccounts.write(persistedAccountData{addr: addrs[0], accountData: basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 1}}}})
	outAccountDeltas = makeCompactAccountDeltas(accountDeltas, baseAccounts)
	outCreatableDeltas = compactCreatableDeltas(creatableDeltas)
