...
func collapseAssetHoldings(qabq, qaed *sql.Stmt, eah ledgercore.ExtendedAssetHolding, holdings map[basics.AssetIndex]basics.AssetHolding, deleted []basics.AssetIndex) (assets map[basics.AssetIndex]basics.AssetHolding, err error) {
	// 1. load all
