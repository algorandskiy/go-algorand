...
func TestAccountDeltas(t *testing.T) {
	...
	sample1 := basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 123}}}
	...
	sample2 := basics.AccountData{MiniAccountData: basics.MiniAccountData{MicroAlgos: basics.MicroAlgos{Raw: 456}}}
