...
func TestMarshalUnmarshalAssetsHoldingGroupDataElement(t *testing.T) {
	v := AssetsHoldingGroupDataElement{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRandomizedEncodingAssetsHoldingGroupDataElement(t *testing.T) {
	protocol.RunEncodingTest(t, &AssetsHoldingGroupDataElement{})
}

func BenchmarkMarshalMsgAssetsHoldingGroupDataElement(b *testing.B) {
	v := AssetsHoldingGroupDataElement{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgAssetsHoldingGroupDataElement(b *testing.B) {
	v := AssetsHoldingGroupDataElement{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalAssetsHoldingGroupDataElement(b *testing.B) {
	v := AssetsHoldingGroupDataElement{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalPersistedAdRecord(t *testing.T) {
	v := PersistedAdRecord{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingPersistedAdRecord(t *testing.T) {
	protocol.RunEncodingTest(t, &PersistedAdRecord{})
}

func BenchmarkMarshalMsgPersistedAdRecord(b *testing.B) {
	v := PersistedAdRecord{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgPersistedAdRecord(b *testing.B) {
	v := PersistedAdRecord{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalPersistedAdRecord(b *testing.B) {
	v := PersistedAdRecord{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
