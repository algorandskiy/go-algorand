...
type AbstractAssetGroup interface {
	...
	Fetch(fetcher func(int64) ([]byte, error), assets interface{}) error
...
func (g *AssetsHoldingGroup) Fetch(fetcher func(int64) ([]byte, error), assets interface{}) error {
	var holdings map[basics.AssetIndex]basics.AssetHolding
	if assets != nil {
		holdings = assets.(map[basics.AssetIndex]basics.AssetHolding)
	}

	buf, err := fetcher(g.AssetGroupKey)
	if err != nil {
		return err
	}
...
func (g *AssetsParamsGroup) Fetch(fetcher func(int64) ([]byte, error), assets interface{}) error {
